        ...
        <ul>
          ...
          <li>
            ...
            <span className="ml-2">
              ...
              <br/>
              <pre className="inline-flex px-2 py-1 my-2 rounded">$ OLLAMA_ORIGINS=https://completely-local-pdf-chatbot-llm-powered.vercel.app OLLAMA_HOST=127.0.0.1:11435 ollama serve
              </pre>
              <br/>
